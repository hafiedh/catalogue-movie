...
class FakeMainRepository(
    ...
    override fun getMovieFromDb(): LiveData<Resource<List<MovieEntity>>> {
    ...
    override fun getTvShow(tvShowId: Int): LiveData<Resource<TvEntity>> {
    ...
    override fun getTvShowAsPaged(): LiveData<Resource<PagedList<TvEntity>>> {
